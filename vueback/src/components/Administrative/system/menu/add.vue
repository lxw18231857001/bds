	...
	<div class="m-l-50 m-t-30 w-500">
		<el-form ref="form" :model="form" :rules="rules" label-width="110px">
			...
			<el-form-item label="英文标题" prop="en_title">
				<el-input v-model.trim="form.en_title" class="h-40 w-200"></el-input>
			</el-form-item>
			<el-form-item label="绑定权限标识" prop="rule_name">
				<el-input v-model.trim="form.rule_name" placeholder="如：栏目管理二级菜单" class="h-40 fl w-200" :disabled="true"></el-input>
			...
			<el-form-item label="路径">
				<el-input v-model.trim="form.url"   placeholder="如：/home/service/list" class="h-40 w-200"></el-input>
			</el-form-item>
			<el-form-item label="NAV">
				<el-input v-model.trim="form.nav" placeholder="如：/serve" class="h-40 w-200"></el-input>(前台导航链接)
			</el-form-item>
			<el-form-item label="模块" prop="module">
				<el-input v-model.trim="form.module" placeholder="如：Administrative" class="h-40 w-200"></el-input>
			</el-form-item>
			<el-form-item label="所属菜单">
				<el-input v-model.trim="form.menu" placeholder="如：category" class="h-40 w-200"></el-input>
			</el-form-item>
