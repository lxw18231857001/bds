  ...
  <div class="m-l-50 m-t-30 w-1000">
    <el-form ref="form" :model="form" :rules="rules" label-width="130px">
      ...
      <el-form-item label="父级分类" prop="pid">
        <el-select v-model="form.pid" placeholder="父级分类" class="w-200">
...
<script>
  ...
  export default {
    ...
    methods: {
      edit(form) {
        this.$refs[form].validate((valid) => {
          if (valid) {
            ...
            this.apiPut('admin/casetype/', this.form.id, this.form).then((res) => {
      ...
      getcasetype() {
        this.apiGet('admin/casetype').then((res) => {
          this.handelResponse(res, (data) => {
            _(data).forEach((ret) => {
      ...
      getStructureInfo() {
        ...
        this.apiGet('admin/casetype/' + this.form.id).then((res) => {
          this.handelResponse(res, (data) => {
