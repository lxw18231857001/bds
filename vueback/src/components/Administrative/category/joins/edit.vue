...
export default {
  ...
  methods: {
    edit(form) {
      this.$refs[form].validate((valid) => {
        if (valid) {
          ...
          this.apiPut('admin/joins/', this.form.id, this.form).then((res) => {
    ...
    getSerInfo() {
      ...
      this.apiGet('admin/joins/' + this.form.id).then((res) => {
        this.handelResponse(res, (data) => {
