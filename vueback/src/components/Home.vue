...
<el-row class="panel m-w-1280">
  <el-col :span="24" class="panel-top">
    ...
    <el-col :span="16" class="ofv-hd">
      <div class="fl p-l-20 p-r-20 top-menu" :class="{'top-active': menu.selected}" v-for="menu in topMenu" @click="switchTopMenu(menu)"></div>
      <!-- <div class="fl p-l-20 p-r-20 top-menu" v-for="menu in topMenu" @click="switchTopMenu(menu)"></div> -->
    </el-col>
